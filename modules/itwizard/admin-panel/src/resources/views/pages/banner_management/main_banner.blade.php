    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <button type="button" class="search-icon btn-shadow btn btn-success CreateModalShow" onclick="window.location.href='/cms/banner_management/add_main_banner'">
            ...
            <table style="width: 100%;" id="example"  class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>사용함</td>
                        <td>
                            <button class="btn-sm mb-2 me-2 btn-icon btn-icon-only btn-pill btn btn-outline-primary" onclick="window.location.href='/cms/banner_management/edit_main_banner'">
