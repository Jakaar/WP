            ...
            <div class=" p-3 border-left-kant">
                <ul class="todo-list-wrapper list-group list-group-flush">
                    <li class="list-group-item">
                        ...
                        <ul>
                            <li>Code should be added near the top of the &lt;head/&gt; tag and before any other scripts or CSS tags</li>
                        </ul>
                    </li>
                </ul>
            </div>
                            ...
                            <li>
                                <span style="vertical-align: inherit;">
                                    <span style="vertical-align: inherit;">Insert the above log analysis code into the first
                                        line of the website's first page (index.htm, index.html, index.jsp).</span>
                                </span>
                            </li>
                            <li>
                                <span style="vertical-align: inherit;">
