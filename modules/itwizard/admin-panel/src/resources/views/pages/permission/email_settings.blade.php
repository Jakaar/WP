                            ...
                            <div class="row">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="form-check form-check-inline mb-3">
                                        <input class="form-check-input" type="radio" name="email_signture"
                                            id="s_use" value="option1" checked>
                                        <label class="form-check-label" for="s_use">use</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="email_signture"
                                            id="s_not_use" value="option2" >
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="form-check form-check-inline mb-2">
                                        <input class="form-check-input" type="radio" name="show Email"
                                    ...
                                    <div class="w-100 border border-info text-muted p-4">
                                        <ul>
                                            <li> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse, cumque vero ipsa aliquid tempore fugit sed ducimus rerum facere sint. Ducimus praesentium necessitatibus eius sequi asperiores odit, deleniti perferendis soluta. </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-6">
