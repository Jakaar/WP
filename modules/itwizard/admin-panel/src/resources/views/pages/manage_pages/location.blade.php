    ...
    <div class="main-card mb-3 card mt-4 card-btm-border card-shadow-primary border-primary">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-10">
                    <input value="오시는길" placeholder="with ABC a placeholder" type="email" class="form-control text-lowercase">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input value="/location" placeholder="with ABC a placeholder" class="form-control text-lowercase">
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <input value="location" placeholder="with ABC a placeholder" class="form-control text-lowercase">
                    </div>
                    <div class="position-relative mb-3" id="PageContent6" name="PageContent">
                            ...
                            <div class="section-content container">
                                ...
                                <div class="d-md-flex mappage-item">
                                    ...
                                    <div class="mappage-content">
                                        <div class="d-inline-flex align-items-center mr-5 w-100 mb-3"><img alt="" class="mr-3" src="/images/contact-icon-map.png" /> 서울 금천구 가산디지털1로 5 대륭테크노타운20차 402호</div>
...
<script>
    $(document).ready(function() {
        let editor;
        ClassicEditor.create(document.querySelector('#PageContent6'))
            .then(newEditor => {
                editor = newEditor;
            })
            .catch(error => {
