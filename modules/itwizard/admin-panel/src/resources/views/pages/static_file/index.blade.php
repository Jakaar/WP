            ...
            <div class="col-md-12">
                <div class="card mb-3 card-btm-border border-primary">
                    <div class="card-body">
                        ...
                        <table style="width: 100%;" id="new_table_1"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>client/static/{{$static_file->type_name}}/{{$static_file->file_absolute_path}}</td>
                                    <td>
                    ...
                    <div class="row">
                        <form action="#" id="createForm" class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <input type="file" class="form-control"  name="upload_file" id="upload_file" data-msg-required="{{ __('This Field is Required') }}" required>
                            </div>

                            <div class="mb-3 col-lg-6">
                                <label for="exampleCity" class="form-label">{{ __('Is Used') }}</label>
                                <select name="status" id="status" class="form-select form-control" data-msg-required="{{ __('This Field is Required') }}" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#" id="updateForm" class="row">
                        ...
                        <div class="mb-3 col-lg-6">
                            <label class="form-label"> {{ __('File') }} </label>
                            <input type="file" class="form-control"  name="upload_file1" id="upload_file1" data-msg-required="{{ __('This Field is Required') }}">
                        </div>

                        <div class="mb-3 col-lg-6">
                            <label for="exampleCity" class="form-label">{{ __('Is Used') }}</label>
                            <select name="status1" id="status1" class="form-select form-control" data-msg-required="{{ __('This Field is Required') }}" required>
                                <option value="" >{{ __('Select') }}</option>
                                <option value="2" >{{ __('Used') }}</option>
                                <option value="1">{{ __('Not Used') }}</option>
                            </select>
