...
<nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent bg-white py-2">
    <div class="container">
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center ml-lg-auto">
                ...
                @foreach($Main['menu'] as $menu)
                    ...
                    <li class="nav-item dropdown">
                        <a href="/{{$menu->board_master_id}}/{{$menu->id}}" class="nav-link" data-toggle="dropdown" role="button">
                            <i class="ni ni-app d-lg-none"></i>
