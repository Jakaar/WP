                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="position-relative mb-3">
                                        ...
                                        <input id="phone" name="phone" placeholder="{{__('Phone number')}}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="position-relative mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="position-relative mb-3">
                                        ...
                                        <input id="facebook" name="facebook" placeholder="{{__('Facebook account')}}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="position-relative mb-3">
                                        <label for="youtube" class="form-label">{{__('Youtube')}}</label>
                                        <input id="youtube" name="youtube" placeholder="{{__('Youtube account')}}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="position-relative mb-3">
                                        <label for="twitter" class="form-label">{{__('Twitter')}}</label>
                                        <input id="twitter" name="twitter" placeholder="{{__('Twitter account')}}" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="position-relative mb-3">
                                        <label for="linkedin" class="form-label">{{__('Linked in')}}</label>
                                        <input id="linkedin" name="linkedin" placeholder="{{__('Linked in account')}}" type="text" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        <button type="button" class="mt-2 btn btn-primary disabler">{{__('Edit')}}</button>
